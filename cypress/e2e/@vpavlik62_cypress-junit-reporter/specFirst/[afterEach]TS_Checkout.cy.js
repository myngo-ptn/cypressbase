...
describe("[@vpavlik62_cypress-junit-reporter][specFirst][afterEach][TC fail in 'after each' hook passes] Check out", () => {
    let accountsData;
    ...
    it("C6106 Verify that the user can not checkout with First Name blank", function () {
    ...
    it("C6107 Verify that the user can not checkout with Last Name blank", function () {
    ...
    it("C6108 Verify that the user can not checkout with Zip Code blank", function () {
        checkoutPage.getFirstNameInput()
            .type(accountsData.checkout.firstName);
        checkoutPage.getLastNameInput()
            .type(accountsData.checkout.lastName);
    ...
    it("C6109 Verify that the user can checkout with a valid First Name, Last Name, and Zip Code", function () {
        checkoutPage.getFirstNameInput()
            .type(accountsData.checkout.firstName);
        checkoutPage.getLastNameInput()
            .type(accountsData.checkout.lastName);
