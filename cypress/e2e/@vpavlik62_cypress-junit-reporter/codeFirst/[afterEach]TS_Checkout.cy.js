...
describe("[@vpavlik62_cypress-junit-reporter][codeFirst][afterEach][TC fail in 'after each' hook passes] Check out", () => {
    let accountsData;
    ...
    it("Verify that the user can not checkout with First Name blank", function () {
    ...
    it("Verify that the user can not checkout with Last Name blank", function () {
    ...
    it("Verify that the user can not checkout with Zip Code blank", function () {
        checkoutPage.getFirstNameInput()
            .type(accountsData.checkout.firstName);
        checkoutPage.getLastNameInput()
            .type(accountsData.checkout.lastName);
    ...
    it("Verify that the user can checkout with a valid First Name, Last Name, and Zip Code", function () {
        checkoutPage.getFirstNameInput()
            .type(accountsData.checkout.firstName);
        checkoutPage.getLastNameInput()
            .type(accountsData.checkout.lastName);
