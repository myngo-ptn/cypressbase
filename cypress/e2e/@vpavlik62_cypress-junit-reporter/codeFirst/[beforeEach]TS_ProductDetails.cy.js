...
describe("[@vpavlik62_cypress-junit-reporter][codeFirst][beforeEach] Product Details", () => {
    let accountsData;
    ...
    it("Verify that product detail is displayed precisely on Product Details page when navigating from Inventory page", function () {
    ...
    it("Verify that the user can remove an added product on the Product Details page", function () {
