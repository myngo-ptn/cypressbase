...
describe("[junit][specFirst][afterEach][TC fail in 'after each' hook fails] Check out", () => {
    let accountsData;
    ...
    it("C6067 Verify that the user can not checkout with First Name blank", function () {
    ...
    it("C6068 Verify that the user can not checkout with Last Name blank", function () {
    ...
    it("C6069 Verify that the user can not checkout with Zip Code blank", function () {
        checkoutPage.getFirstNameInput()
            .type(accountsData.checkout.firstName);
        checkoutPage.getLastNameInput()
            .type(accountsData.checkout.lastName);
    ...
    it("C6070 Verify that the user can checkout with a valid First Name, Last Name, and Zip Code", function () {
        checkoutPage.getFirstNameInput()
            .type(accountsData.checkout.firstName);
        checkoutPage.getLastNameInput()
            .type(accountsData.checkout.lastName);
